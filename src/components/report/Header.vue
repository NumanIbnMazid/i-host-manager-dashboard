  ...
  <div>
    <div class="vx-row">
      ...
      <div
        class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4"
        style="cursor: pointer"
        @click="showReport('/report/date-wise')"
      >
        <vs-card class="mb-3 border">
          <div class="flex">
            <div class="w-1/2">
      ...
      <div
        class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4"
        style="cursor: pointer"
        @click="showReport('/report/waiter-wise')"
      >
        <vs-card class="mb-3 border">
          <div class="flex">
            <div class="w-1/2">
      ...
      datasets: [
        {
          ...
          data: [5818.8, 4000, 7644, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        },
      ],
    },
    weekChart: {
...
.border {
  border: 0.1rem solid #f8b94300 !important;
}
.border-ih {
  border: 0.1rem solid #f8b843 !important;
}
</style>