...
<!--            </vs-button>-->
            ...
            <vs-button
              ...
              @click="collectOrdersPayment(order)"
    ...
    <vs-popup title="Invoice Preview" :active.sync="collectPaymentsShow">
      <CollectPayments
        :therOrder="collectPaymentsOrder"
...
<body>
    ...
    collectOrdersPayment(order) {
      this.collectPaymentsShow = true;
      this.collectPaymentsOrder = order;
      // axios
    ...
    afterCollectPayments(changedOrder) {
